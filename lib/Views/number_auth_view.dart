            ...
            children: [
              ...
              GestureDetector(
                  child: Container(
                    ...
                    height: 56.h,
                    decoration: BoxDecoration(
                      gradient: phoneVerificationController.isCorrectCode.value ?? false
                          ? LinearGradient(
                              colors: [
                                Theme.of(context).colorScheme.onSecondary,
                          ...
                          : null,
                      color: !(phoneVerificationController.isCorrectCode.value ?? false)
                          ? grayScale[30]
                          : null,
                      borderRadius: BorderRadius.all(Radius.circular(8.w)),
                    ),
                  ...
                  onTap: () async {
                    if (phoneVerificationController.isCorrectCode.value ?? false) {
                      ...
                      await userController
                          .getUserInfoByEmail(authController.userEmail.value!);
